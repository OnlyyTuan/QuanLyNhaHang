...
public class HeaderBarNV extends javax.swing.JPanel {
    ...
    public HeaderBarNV(NhanVien nhanVienPanel) {
        ...
        // Cập nhật các tùy chọn tìm kiếm phù hợp
        jComboBoxSearchType.setModel(new javax.swing.DefaultComboBoxModel<>(
            new String[] { "Tên", "Chức vụ", "Giới Tính", "Trạng Thái" }
        ));
    }
    ...
    private void jComboBoxSearchTypeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxSearchTypeActionPerformed
        // Có thể thêm xử lý khi đổi kiểu tìm kiếm nếu cần
    }//GEN-LAST:event_jComboBoxSearchTypeActionPerformed

    private void jButtonSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSearchActionPerformed
        String keyword = jTextFieldSearchBar.getText().trim();
        String searchType = (String) jComboBoxSearchType.getSelectedItem();

        if (nhanVienPanel != null) {
            nhanVienPanel.searchTableData(keyword, searchType);
        }
    ...
    private void jButtonModifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonModifyActionPerformed
        if (nhanVienPanel != null) {
            int selectedId = nhanVienPanel.getSelectedTableId();
            if (selectedId != -1) {
                NhanVienDialog nhanVienDialog = new NhanVienDialog(selectedId);
                nhanVienDialog.setVisible(true);
            }
        }
    ...
    private void jButtonDetailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDetailActionPerformed
        // Có thể triển khai hiện dialog chi tiết ở đây nếu cần
    ...
    private void jTextFieldSearchBarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldSearchBarActionPerformed
        // Xử lý khi nhấn Enter trong ô tìm kiếm (nếu cần)
