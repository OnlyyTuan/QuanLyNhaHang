...
public class HeaderBar extends javax.swing.JPanel {
    private BanAn banAnPanel;
    /**
     * Creates new form HeaderBar
     */
    public HeaderBar(BanAn banAnPanel) {
        initComponents();
        this.banAnPanel = banAnPanel;
    }
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        ...
        BanAnDialog banAndialog = new BanAnDialog();    
        banAndialog.setVisible(true);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        if (banAnPanel != null) {
            banAnPanel.deleteTable(banAnPanel.getSelectedTableId());
        }
