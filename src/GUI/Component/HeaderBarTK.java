 ...
 * @author MSI
 */
public class HeaderBarTK extends javax.swing.JPanel {
    private TaiKhoan taiKhoanPanel;
    /**
     * Creates new form HeaderBar
     */
    public HeaderBarTK(TaiKhoan taiKhoanPanel) {
        initComponents();
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        // TODO add your handling code here:
        if (taiKhoanPanel != null) {
            taiKhoanPanel.deleteTable(taiKhoanPanel.getSelectedTableId());
        }
