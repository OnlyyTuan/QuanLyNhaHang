 ...
 * @author MSI
 */
public class HeaderMA extends javax.swing.JPanel {
    private MonAn monAnPanel;
    /**
     * Creates new form HeaderBar
     */
    public HeaderMA(MonAn monAnPanel) {
        initComponents();
        this.monAnPanel = monAnPanel;
    }
    ...
    private void initComponents() {
        ...
        jButtonExport.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                if (monAnPanel != null) {
                    try {
                        JTableExporter.exportJTableToExcel(monAnPanel.getTable());
                    } catch (Exception e) {
    ...
    private void jButtonSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSearchActionPerformed
        if (monAnPanel != null) {
            ...
            monAnPanel.searchMonAn(searchText, searchType);
        }
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        ...
        MonAnDialog monAndialog = new MonAnDialog();    
        monAndialog.setVisible(true);
    }//GEN-LAST:event_jButtonAddActionPerformed

    private void jButtonModifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonModifyActionPerformed
        // TODO add your handling code here:
        if (monAnPanel != null) {
            monAnPanel.openModifyDialog();
        }
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        // TODO add your handling code here:
        if (monAnPanel != null) {
            monAnPanel.deleteTable(monAnPanel.getSelectedTableId());
        }
